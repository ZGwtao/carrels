...
COPY_TABLE = [
    ...
    ("serial_client_protocon4.data", 2),
    ("serial_client_protocon5.data", 2),
    ("serial_client_protocon6.data", 2),
    ("serial_client_protocon7.data", 2),
    ("serial_client_protocon8.data", 2),
    ("serial_client_protocon9.data", 2),
    ("serial_client_protocon10.data", 2),
    ("serial_client_protocon11.data", 2),
    ("serial_client_protocon12.data", 2),
    ("serial_client_protocon13.data", 2),
    ("serial_client_protocon14.data", 2),
    ("serial_client_protocon15.data", 2),
    ...
    ("timer_client_protocon4.data", 2),
    ("timer_client_protocon5.data", 2),
    ("timer_client_protocon6.data", 2),
    ("timer_client_protocon7.data", 2),
    ("timer_client_protocon8.data", 2),
    ("timer_client_protocon9.data", 2),
    ("timer_client_protocon10.data", 2),
    ("timer_client_protocon11.data", 2),
    ("timer_client_protocon12.data", 2),
    ("timer_client_protocon13.data", 2),
    ("timer_client_protocon14.data", 2),
    ("timer_client_protocon15.data", 2),
]
