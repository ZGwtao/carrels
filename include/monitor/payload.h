...
static inline size_t monitor_protocon_capacity(void)
{
    return (size_t)(__carrels_protocon_end - __carrels_protocon_start);
}

static inline size_t monitor_trampoline_capacity(void)
{
    return (size_t)(__carrels_trampoline_end - __carrels_trampoline_start);
}
