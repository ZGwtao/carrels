 ...
 *                      Empty string if complete not found, and multiple string if there are some
 * token
 */
...
typedef struct microrl {
    ...
    char cmdline_str[MICRORL_CFG_CMDLINE_LEN +
                     1]; /*!< Command line input buffer with NULL character */
